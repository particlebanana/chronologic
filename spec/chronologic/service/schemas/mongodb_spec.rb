...
describe Chronologic::Service::Schema::MongoDB do 

  before do
    @schema = Chronologic::Service::Schema::MongoDB
  end
  ...
  # Not quite sure why the timeline was sorted the way it was in the
  # original schema test for cassandra. I think it should return the last
